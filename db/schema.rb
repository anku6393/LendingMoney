...
ActiveRecord::Schema[7.0].define(version: 2024_10_30_074600) do
  ...
  create_table "loans", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.datetime "interest_calculated_at"
    t.decimal "calculate_interest", precision: 10, scale: 2, default: "0.0"
